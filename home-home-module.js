        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        for (i = 0; i < this.availableForms.length; i++) {
...
/* harmony import */ var _transaction_class__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./transaction-class */ "./src/app/transaction-class.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SocketService = /** @class */ (function () {
    ...
    SocketService.prototype.transactionEmitter = function (value, transactionName, returnName) {
        var _this = this;
        var transaction = new _transaction_class__WEBPACK_IMPORTED_MODULE_3__["Transaction"]();
        //Random HEX to new transaction
        //EVERY Transaction MUST have a new random HEX to ID it
        transaction.ID = (Math.random() * 0xFFFFFF << 0).toString(16);
        console.log('------' + transaction.ID + '-----');
        //Socket connection
        this.socket = socket_io_client__WEBPACK_IMPORTED_MODULE_2__["connect"](this.serverAddress, { reconnection: false });
        this.socket.emit(transactionName, value, transaction.ID);
        console.log('EMITTED');
        this.socket.on(transaction.ID, function (data) {
            ...
            _this.events.publish(returnName, transaction);
